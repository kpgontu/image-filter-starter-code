...
function filterImageFromURL(inputURL) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            let photo;
            try {
                photo = yield Jimp.read(inputURL);
                const outpath = '/tmp/filtered.' + Math.floor(Math.random() * 2000) + '.jpg';
                console.log("Image saved path : " + outpath);
                if (photo) {
                    yield photo
                ...
                console.log("Exception in filterImageFromUrl " + e);
            }
        }));
    });
}
...
function deleteLocalFiles(files) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("Exception in deleteLocalFiles " + e);
        }
    });
}
